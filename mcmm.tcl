...
#set_voltage 0.78
#set_temperature 125
set_parasitics_parameters -corner FUNC_0.78V_SETUP -library ${DESIGN_LIBRARY} -early_spec maxTLU -late_spec minTLU
current_scenario FUNC_0.78V_SETUP
read_sdc $dir/sdc/bit_coin.sdc
...
set_voltage 0.85 -object_list *SS_MEM_SW.power
set_voltage 0.78 -object_list *SSL*.power
set_voltage 0.0 -object_list  *.ground*
...
#set_voltage 0.85
#set_temperature 125
set_parasitics_parameters -corner FUNC_0.85V_SETUP -library ${DESIGN_LIBRARY} -early_spec maxTLU -late_spec minTLU
...
#set_voltage 0.85
#set_temperature 125
set_parasitics_parameters -corner FUNC_0.85V_HOLD -library ${DESIGN_LIBRARY} -early_spec maxTLU -late_spec minTLU
